...
public class Service_facilities extends Entries{
	private String name;
	private Double price;
	public Service_facilities(String a,String b,Double c){
		super(a);
		name = b;
		price = c;
		message_ord = new String("%s%s%f");
	}
	public Service_facilities(){
		super(null);
		name = null;
		price = null;
		message_ord = new String("%s%s%f");
	...
	public Entries from_Message_node(Message_node m){
		...
		return new Service_facilities(a,b,c);
	}
